package cc.xuepeng.ray.framework.module.log.api.controller;
...
import cc.xuepeng.ray.framework.module.log.api.facade.SysAuthLogFacade;
...
public class SysAuthLogController extends BaseController {
     ...
     */
    @GetMapping("/v1/page")
    //@OperateLog(module = "系统管理", func = "认证日志管理", remark = "分页查询认证日志", action = SysOperateLogAction.QUERY, persistent = false)
