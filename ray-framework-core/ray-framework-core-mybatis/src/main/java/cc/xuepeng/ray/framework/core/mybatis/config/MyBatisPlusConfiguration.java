...
import cc.xuepeng.ray.framework.core.mybatis.plus.tenant.MyBatisTenantPlus;
...
public class MyBatisPlusConfiguration {
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor(final MyBatisPlusProperty mybatisPlusProperty) {
        ...
        // 租户插件
        if (BooleanUtils.isTrue(myBatisPlusProperty.getTenant().getEnable())) {
            interceptor.addInnerInterceptor(tenantLineInnerInterceptor(myBatisPlusProperty));
        }
        // 添加分页插件
     ...
     */
    @Bean
    public TenantLineInnerInterceptor tenantLineInnerInterceptor(MyBatisPlusProperty myBatisPlusProperty) {
        return new TenantLineInnerInterceptor(new MyBatisTenantPlus(myBatisPlusProperty, identificationService));
    }
